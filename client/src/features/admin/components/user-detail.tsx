        ...
        <div className="flex flex-col space-y-6 animate-in fade-in duration-500">
             ...
             <div className="flex items-center gap-4">
                ...
                <div className="text-sm breadcrumbs text-gray-400">
                    <span className="mr-2">Admin</span> / <span className="mx-2">User Management</span> / <span className="ml-2 font-semibold text-gray-900">User Detail</span>
                </div>
             </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 flex flex-col md:flex-row items-start md:items-center gap-6 border border-gray-100">
                ...
                <div className="flex-1 space-y-2">
                    ...
                    <div className="text-gray-500 font-medium flex items-center gap-2 text-sm">
                        ...
                        <span className="text-gray-400 font-normal">Registered on {new Date(user.date_joined).toLocaleDateString('vi-VN')}</span>
                    </div>
                </div>

                <div className="grid grid-cols-2 gap-x-8 gap-y-4 min-w-[300px] border-l pl-8 border-gray-100">
                        <div className="space-y-1">
                            <p className="text-xs text-gray-400 font-medium uppercase tracking-wider">User ID</p>
            ...
            <Tabs defaultValue="profile" className="w-full">
                ...
                <TabsContent value="profile" className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                {user.business_profile ? (
                                    <>
                                        <div className="col-span-2 space-y-1">
                                            <label className="text-xs font-medium text-gray-400 uppercase">Business Name</label>
                                            <p className="text-sm font-bold text-gray-900">{user.business_profile.business_name}</p>
                                        </div>
                                        <div className="space-y-1">
                                                <label className="text-xs font-medium text-gray-400 uppercase">Tax ID</label>
                                                <p className="text-sm font-semibold text-gray-900">{user.business_profile.tax_id}</p>
                                        </div>
                                            <div className="space-y-1">
                                                <label className="text-xs font-medium text-gray-400 uppercase">License No.</label>
                                    ...
                                    <div className="col-span-2 py-4 text-center text-gray-400 italic">No business profile available</div>
                                )}
                            </CardContent>
                        </Card>
                        ...
                        <Card className="border-none shadow-sm ring-1 ring-gray-100">
                             <CardHeader className="pb-3 border-b flex flex-row items-center justify-between bg-gray-50/30 rounded-t-xl">
                                <CardTitle className="text-base font-bold text-gray-800">Account Status</CardTitle>
                            </CardHeader>
                            <CardContent className="pt-6 space-y-6">
                                    <div className="bg-blue-50 p-6 rounded-xl border border-blue-100 relative overflow-hidden">
                                       ...
                                       <div className="relative z-10">
                                           <h4 className="text-lg font-bold text-blue-900 mb-2">Review Required</h4>
                                           <p className="text-sm text-blue-700 leading-relaxed mb-4 max-w-[80%]">
                                               {user.status === UserStatus.PENDING 
                                                   ? "This account is awaiting administrative approval. Please verify business documents." 
                                                   : `Current status is ${user.status}. Actions may be limited depending on workflow.`}
                                           </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Card className="border-none shadow-sm ring-1 ring-gray-100 col-span-3">
                            <CardHeader className="pb-3 border-b bg-gray-50/30 rounded-t-xl">
                                <CardTitle className="text-base font-bold text-gray-800">Uploaded Documents</CardTitle>
                            </CardHeader>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        <div className="border border-gra-200 rounded-xl p-4 flex flex-col gap-4 hover:shadow-md transition-shadow bg-white group relative">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-gray-500 mt-1">Uploaded on {new Date(user.date_joined).toLocaleDateString()}</p>
                                            </div>

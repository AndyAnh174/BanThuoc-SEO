        ...
        {displayImages.length > 1 && (
          <>
            <button
              ...
              className="absolute left-2 top-1/2 -translate-y-1/2 p-2 bg-white/80 rounded-full shadow-md hover:bg-white transition-colors md:opacity-100 opacity-100"
            ...
            <button
              onClick={goToNext}
              className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-white/80 rounded-full shadow-md hover:bg-white transition-colors md:opacity-100 opacity-100"
